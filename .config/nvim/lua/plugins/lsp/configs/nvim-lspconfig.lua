...
return {
  ...
  config = function()
    local config = {
      -- Enable virtual text
      virtual_text = true,         -- Set this to true to enable inline warnings and errors
      update_in_insert = true,     -- Show diagnostics while typing (in insert mode)
      underline = true,            -- Underline errors and warnings
      severity_sort = true,        -- Sort diagnostics by severity (Error > Warning)
      float = {
        focusable = false,
        style = "minimal",
        border = "rounded",
    ...
    --       },
    --       cargo = {
    --         features = "all",  -- Enable all features for Cargo
    --       },
    --     },
    --   },
    -- })
